...
\begin{document}
  ...
  \include{modelitzacioImplemantacio}
  \include{explicacioParametres}
  \include{limitacionsIproblematica}
  \include{jocProves}
  \include{possiblesAmpliacions}
  \include{criticaValoracio} %% De la practica i tecnologia emprara en si i tamb e de contingut
  \include{annexcodi}
  \input{peu.tex}
